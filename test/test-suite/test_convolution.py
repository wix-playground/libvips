...
from helpers import noncomplex_formats, run_fn2, run_fn, \
    assert_almost_equal_objects, assert_less_threshold, PNG_FILE, LOGO2_PNG_FILE, LOGO3_PNG_FILE, IMAGES
...
class TestConvolution:
    ...
    def test_sharpen_rgb_logo3(self):
        im = pyvips.Image.new_from_file(LOGO3_PNG_FILE)
        sharp = im.sharpen(mode='rgb', sigma=1 + 0.66 / 2, m2=1.0, x1=1.0)
        sharp.write_to_file('%s.sharpened-rgb.png' % LOGO3_PNG_FILE)
